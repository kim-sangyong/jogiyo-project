...
<jsp:include page="../js/owner_membership_js.jsp"/>
...
<h1><span style="font-weight: bold; color:#fa0050; font-family: 'Gothic A1', sans-serif;">점주 회원가입</span></h1>
   ...
   <table style="position:relative; top:25px;">
      <tr>
        <td><a href="https://kauth.kakao.com/oauth/authorize?client_id=${kakao_login}&redirect_uri=${redirect_url}/login/owner_membership.do&response_type=code&scope=talk_message"> <!--  onclick="kakao_btn()" -->
